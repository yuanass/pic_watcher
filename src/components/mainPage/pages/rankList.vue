<template>
  <div class="latest">
    <div class="latestMain">
      ...
      <!--分割线-->
      <!-- <div class="statesItem">
        <div class="userInfo">
          <div class="userHeadImg">
            <img src="@stm/masamisang2.jpg" alt="">
          </div>
          <div class="userName">
            <div class="name">yuanass</div>
            <div class="time">2018-01-11</div>
          </div>
        </div>
        <div class="statesText">
          <div class="text">
            <p>yuanshajojaihflaksfkalsfhashfkjahsfkhaskjhakshkashflwpqiuqjdlkajsldkjaslkdjlaskjdlkasjdlsjyuans
              hajojaihflaksfkalsfhashfkjahsfkhaskjhakshkashflwpqiuqjdlkajsldkjaslkdjlaskjdlkasjdlsj
            </p>
          </div>
        </div>
        <div class="statesPhoto">
          <img src="@stm/y.jpg" alt="">
        </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      //     }
      //   });
      this.allPostTsd = this.$storage.loadStorage("ALL_POST");
      this.sort(this.allPostTsd);
      ...
      sort(allPost) {
        ...
        for (i = 0; i < arr.length - 1; i++) {
          for (j = 0; j < arr.length - 1 - i; j++) {
            if (arr[j].thumbNum > arr[j + 1].thumbNum) {
              let tmp = arr[j];
              arr[j] = arr[j + 1];
              arr[j + 1] = tmp;
            }
        ...
        this.allPost = arr.reverse();
      },
      getAllThumbNum() {
        this.axios
          .get("http://localhost:3000/getAllThumbNum", {
            headers: {
              "Content-Type": "multipart/form-data",
              "Content-Type": "application/x-www-form-urlencoded"
            }
          ...
          .then(response => {
            ...
            for (i = 0; i < arr.length; i++) {
              ...
              this.allThumbNum.push(arr[i]);
            }
            // console.log(this.allPostTsd);
            // console.log(this.allThumbNum);
          });
      },
      getUserThumbInfo() {
